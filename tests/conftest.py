...
The HA-layer tests live in ``tests_ha/`` with their own conftest and pytest
configuration; this suite runs with the pytest-homeassistant plugin explicitly
disabled (see pyproject addopts).
"""
